...
This outlines how to propose a change to copynumber. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("igordot/copynumber", fork = TRUE)`.
...
Please note that the copynumber project is released with a [Contributor
Code of
Conduct](https://igordot.github.io/copynumber/CODE_OF_CONDUCT.md). By
