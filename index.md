...
[copynumber](http://bioconductor.org/packages/release/bioc/html/copynumber.md)
R package. It has been modified to support the human hg38 and mouse mm10
genome builds. Specifically, this is used for the `assembly` parameter
in `aspcf`, `multipcf`, `pcf`, and `winsorize` functions.
...
This fork is based on copynumber 1.29.0 (part of Bioconductor 3.12). The
package was removed from Bioconductor in version 3.18. The specific
version is likely not relevant for most applications as there have been
no changes to the code since 2013.
