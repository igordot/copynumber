...
- [`logR`](https://igordot.github.io/copynumber/reference/SNPdata.md)
  [`BAF`](https://igordot.github.io/copynumber/reference/SNPdata.md) :
...
- [`copynumber`](https://igordot.github.io/copynumber/reference/copynumber-package.md)
  ...
  by Penalized Least Squares Regression (with hg38/mm10/mm39)
...
- [`lymphoma`](https://igordot.github.io/copynumber/reference/lymphoma.md)
  : 3K aCGH data
- [`micma`](https://igordot.github.io/copynumber/reference/micma.md) :
...
- [`pcfPlain()`](https://igordot.github.io/copynumber/reference/pcfPlain.md)
  : Plain single-sample copy number segmentation.
- [`plotAberration()`](https://igordot.github.io/copynumber/reference/plotAberration.md)
...
- [`plotCircle()`](https://igordot.github.io/copynumber/reference/plotCircle.md)
  : Plot a circular genome with aberration frequencies and connections
  between genomic loci added.
- [`plotFreq()`](https://igordot.github.io/copynumber/reference/plotFreq.md)
  : Plot percentage of samples with an aberration at a genomic position
- [`plotGamma()`](https://igordot.github.io/copynumber/reference/plotGamma.md)
...
- [`plotHeatmap()`](https://igordot.github.io/copynumber/reference/plotHeatmap.md)
...
- [`subsetData()`](https://igordot.github.io/copynumber/reference/subsetData.md)
  : Retrieve a data subset
- [`subsetSegments()`](https://igordot.github.io/copynumber/reference/subsetSegments.md)
