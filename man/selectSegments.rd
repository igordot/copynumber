...
% Please edit documentation in R/selectSegments.r
\name{selectSegments}
\alias{selectSegments}
\title{Select multipcf segments}
\usage{
selectSegments(
  segments,
  what = "variance",
...
\arguments{
\item{segments}{a data frame containing segments found by
\code{\link{multipcf}}.}

\item{what}{the desired characteristic to base selection on. Must be one of
...
\item{nseg}{the desired number of segments to be selected, default is 10.
Only used if \code{thres=NULL}.}

\item{large}{logical value indicating whether segments with large (TRUE) or
small (FALSE) variance, length or mean value should be selected when
\code{what} is "variance", "length" or "aberration", respectively.}

\item{p}{a number between 0 and 1 giving the minimum proportion of samples
for which an aberration must be detected, default is 0.1. Only applicable if
\code{what="aberration"}.}
}
\value{
A list containing: \item{sel.seg}{data frame containing the selected
