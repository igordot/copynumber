...
% Please edit documentation in R/pcfPlain.r
\name{pcfPlain}
\alias{pcfPlain}
...
\arguments{
\item{pos.data}{a data frame where the rows represent the probes, column 1
...
\note{
If probe positions are not available, the first column in \code{data}
