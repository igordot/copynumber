...
% Please edit documentation in R/plotAberration.r
\name{plotAberration}
\alias{plotAberration}
\title{Plot areas with copy number aberrations}
\usage{
plotAberration(
  segments,
  thres.gain,
...
\item{thres.gain}{a numeric vector giving the threshold value(s) to be
applied for calling gains.}

\item{thres.loss}{a numeric vector of same length as \code{thres.gain}
...
\item{layout}{the vector of length two giving the number of rows and columns
in the plot window. Default is \code{c(1,1)}.}

\item{\dots}{other optional graphical parameters. These include the plot arguments
