...
\name{plotGamma}
\alias{plotGamma}
\title{Plot segmentation results for several values of gamma}
\usage{
plotGamma(
  data,
  pos.unit = "bp",
...
\item{gammaRange}{a vector of length two giving the lowest and highest value
...
\item{dowins}{logical value indicating whether data should be winsorized
before running \code{pcf}. Default is TRUE.}

\item{sample}{an integer indicating which sample is to be segmented. The
...
\item{chrom}{a number or character indicating which chromosome is to be
segmented. Default is chromosome 1.}

\item{cv}{logical value indicating whether K-fold cross-validation should be
done, see details.}

\item{K}{the number of folds to use in K-fold cross-validation, default is
5.}
...
\value{
If \code{cv = TRUE} a list containing: \item{gamma}{the gamma values
