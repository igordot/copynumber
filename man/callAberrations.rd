...
% Please edit documentation in R/callAberrations.r
\name{callAberrations}
\alias{callAberrations}
\title{Call aberrations in segmented data}
\usage{
...
\item{thres.gain}{a numeric value giving the threshold to be applied for
calling gains.}

\item{thres.loss}{a numeric value giving the threshold to be applied for
calling losses. Default is to use the negative value of \code{thres.gain}.}
}
\value{
A new segment data frame where the segment values have been replaced
