...
- `addChromlines()`, `get.seglim()`, and
  ...
  had minor bugs fixed; several error messages had incomplete or
...
- 1.41.0 — devel bump after Bioconductor 3.17 (2023-04-25); no further
  releases followed
- 1.40.0 — Bioconductor 3.17 (2023-04-25); final Bioconductor release
- 1.39.1 — marked `Deprecated` (unresponsive maintainer, invalid contact
  email)
...
- 1.29.0 — devel bump after Bioconductor 3.11; parent of this fork’s
  1.29.0.9000 (2020-04-27)
...
- [`plotHeatmap()`](https://igordot.github.io/copynumber/reference/plotHeatmap.md)
  now uses different colors above and below zero, instead of assuming
  `upper.lim`/`lower.lim` are symmetrical.
